...
public class MediaFile {
	...
	private void parseUploadResult(String result){
		...
		if(jsonObject.entrySet().contains(PARAM_MEDIA_ID)){
			this.mediaId = jsonObject.get(PARAM_MEDIA_ID).getAsString();
			this.createdTimestamp = jsonObject.get(PARAM_CREATE_TIME).getAsString();
		}
		else{
			this.mediaId = null;
